...
import { type loadingVariants } from '.'
...
>((props, ref) => {
	...
	const style = {
		...
		'--dashoffset-97': `${calcPercCircumference(97)}px`,
		'--dashoffset-25': `${calcPercCircumference(25)}px`,
	...
	return (
		...
		>
			<circle
				className="origin-center animate-line-spinner"
				cx={dimension / 2}
				cy={dimension / 2}
